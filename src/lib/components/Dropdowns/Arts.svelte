...
>
  ...
  <button
    ...
    class="relative z-10 block p-2 text-gray-700 border border-transparent dark:text-white focus:outline-none transition hover:text-sky-500 dark:hover:text-sky-400"
  > Artes
