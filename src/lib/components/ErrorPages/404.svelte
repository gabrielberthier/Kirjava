<script lang="ts">
  ...
  import { getWidth, getHeight } from '$lib/dom/sizing'

  //based on https://dribbble.com/shots/3913847-404-page
  if (browser) {
    let pageX = getWidth(document)
    let pageY = getHeight(document)
    let mouseY = 0
    let mouseX = 0
    ...
    addEventListener('mouseover', (event) => {
      ...
      const el = document.getElementById('ghost-eyes')
      if (el) {
...
<div class="box">
  ...
  <div class="box__description">
    <div class="box__description-container">
      <div class="box__description-title">Lost?</div>
